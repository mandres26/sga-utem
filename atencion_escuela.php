...
<title>Formulario Atención Escuela</title>
...
function valida_envia(){ 
	...
	if (document.pdf.telefono.value.length==0){ 
      	 alert("Escribe Tú Teléfono") 
      	 document.pdf.telefono.focus() 
      	 return 0; 
   	}
	...
	if (document.pdf.problema_planteado.value.length==0){ 
      	 alert("Escribe Tú Problema") 
      	 document.pdf.problema_planteado.focus() 
      	 return 0; 
   	}
...
<div class="sub_content7">
<p style="text-align:center; font-weight:bold; text-decoration:underline">Formulario Atención Escuela</p>
<p>Por favor complete todos los datos requeridos para dar formato al formulario seleccionado.</p>
<form name="pdf" action="procesar_atencion.php" method="post" onsubmit="valida_envia(); return false;">
...
<div class="atencion_campoform4">
<strong>Telefono</strong>:
<input type="text" name="telefono" id="telefono" onkeypress="ValidaSoloNumeros()" maxlength="50" />
</div>
<br />
...
<div class="campoform2-3">
<strong>Problema Planteado:</strong>              
<br>
<textarea name="problema_planteado" wrap=physical cols="60" rows="5" onKeyDown="contador(this.form.problema_planteado,this.form.remLen,500);" onKeyUp="contador(this.form.problema_planteado,this.form.remLen,500);"></textarea>
<input type="text" name="remLen" size="3" maxlength="3" value="500" readonly>te quedan todavía
</div>
<br />
<div class="campoform">
