...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->SetXY(70,35);
	  $this->Write(10,'JUSTIFICATIVO 2144');
	  $this->Ln(15);
   }
...
{
      $this->SetXY(100,-80);
	  $this->Write(10,'Rafael Loyola Berríos');
	  $this->SetXY(108,-72);
...
$pdf->Ln();
$pdf->Write (7,"De: Rafael Loyola Berríos");
$pdf->Ln();
$pdf->Write (7,"Jefe de Carrera Ing. Civil Industrial men. Sistemas de Gestión");
$pdf->Ln();
...
$pdf->Ln();
$pdf->Write (7,"Por intermedio del presente informo a usted que el alumno de    la    carrera    Ingeniería   Civil    Industrial   mención Sistemas de Gestión, Sr(a) ");
...
$pdf->Output("enviar_justificativo/2144/justificativo2144.pdf",'F');		
...
$mail->Subject = "Justificativo 2144"; 
...
$mail->AddAttachment("enviar_justificativo/2144/justificativo2144.pdf"); 
