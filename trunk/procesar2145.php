...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->SetXY(70,35);
	  $this->Write(10,'JUSTIFICATIVO 2145');
	  $this->Ln(15);
   }
...
$pdf->Ln();
$pdf->Write (7,"Jefe de Carrera Ingeniería Industrial");
$pdf->Ln();
...
$pdf->Ln();
$pdf->Write (7,"Por intermedio   del   presente   informo a   usted que   el   alumno  de    la    carrera    Ingeniería   Industrial  , Sr(a) ");
...
$pdf->Output("enviar_justificativo/2145/justificativo2145.pdf",'F');		
...
$mail->Subject = "Justificativo 2145"; 
...
$mail->AddAttachment("enviar_justificativo/2145/justificativo2145.pdf"); 
