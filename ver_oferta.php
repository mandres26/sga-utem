...
<body>
<div class="content4">
<p class="parrafo_oferta">Aquí puedes ver todas las ofertas laborales creadas en el sistema, sin importar la carrera asociada.</p>
<?
include_once ("funciones_comunes.php");
//base de datos conectada en funciones comunes.php :D

$ssql = "select * from oferta, carrera where oferta.id_carrera = carrera.id_carrera order by id_oferta desc limit 4";
$rs = mysql_query($ssql);
